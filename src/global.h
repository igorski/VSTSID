...
namespace VST {
    ...
    static const float MAX_PITCH_BEND       = 12.f; // full octave
    ...
    static const float MIN_RING_MOD_RATE() { return 0.f; }  // off
    static const float MAX_RING_MOD_RATE() { return 10000.0f; }
